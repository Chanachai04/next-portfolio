export const th = {
  ...
  projectDetails: {
    ...
    "expense-app": {
      title: "Expense Assistant - จัดการรายรับ-รายจ่าย กับระบบ AI อัจฉริยะ",
      overview:
        'แอปพลิเคชันจัดการรายรับ-รายจ่ายยุคใหม่ ที่มาพร้อมกับระบบ AI อัจฉริยะ ช่วยให้คุณบันทึกข้อมูลได้ง่ายเพียงแค่ "แชท" หรือ "ส่งรูปสลิป"',
      featureList: [
        " พิมพ์บอกรายการให้ AI บันทึกให้โดยตรง",
        "ส่งรูปสลิปโอนเงินแล้ว AI จะดึงข้อมูล ยอดเงิน/วันเวลา/ผู้รับเงิน ให้โดยอัตโนมัติ",
        "ดูสถิติการใช้เงินในรูปแบบกราฟที่สวยงาม เข้าใจง่าย",
        "ประวัติรายการครบถ้วน ค้นหาย้อนหลังได้สะดวก",
        "หน้าตาระบบที่สะอาด ทันสมัย ในธีมสีขาว-เขียว สบายตา",
      ],
      images: [
        "/projects/expense-app/1.png",
        "/projects/expense-app/2.png",
        "/projects/expense-app/3.png",
        "/projects/expense-app/4.png",
        "/projects/expense-app/5.png",
        "/projects/expense-app/6.png",
        "/projects/expense-app/7.png",
        "/projects/expense-app/8.png",
        "/projects/expense-app/9.png",
        "/projects/expense-app/10.png",
        "/projects/expense-app/11.png",
        "/projects/expense-app/12.png",
        "/projects/expense-app/13.png",
        "/projects/expense-app/14.png",
      ],
    },
  },
};
...
export const en = {
  ...
  projectDetails: {
    ...
    "expense-app": {
      title: "Expense Assistant - Smart Income & Expense Management with AI",
      overview:
        "A next-generation expense tracking application powered by an intelligent AI system, making financial logging as easy as chatting or uploading a receipt.",
      featureList: [
        "Chat directly with the AI to record your transactions",
        "Automatically extract amount, date, time, and recipient from uploaded payment slips",
        "Visualize your spending habits with beautiful and easy-to-read charts",
        "Comprehensive transaction history with convenient search and filter options",
        "Clean, modern interface with a professional white-green theme",
      ],
      images: [
        "/projects/expense-app/1.png",
        "/projects/expense-app/2.png",
